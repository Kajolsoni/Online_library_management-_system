...
<html>
	...
	<body  style="background-color: #F2F5A9">
		<form class="cd-form" method="POST" action="#">
			<legend style="color: black;" >Enter your details</legend>
			
				<div class="error-message" id="error-message">
					<p id="error"></p>
				</div>
				
				<input class="m-user" type="text" name="m_user" id="m_user" placeholder="Username" required /><br>			<input class="m-pass" type="password" name="m_pass" placeholder="Password" required /><br>
				<input class="m-name" type="text" name="m_name" placeholder="Full Name" required /><br>
				<input class="m-email" type="email" name="m_email" id="m_email" placeholder="Email" required /><br>
				<input class="m-balance" type="number" name="m_balance" id="m_balance" placeholder="Initial Balance" required /><br>
