...
<html>
	...
	<body style="background-color: #F2F5A9">
		...
		<legend style="color: black;">Librarian Login</legend>
		
			<div class="error-message" id="error-message">
				<p id="error"></p>
			</div>
			<input class="l-user" type="text" name="l_user" placeholder="Username" required /><br>
				<input class="l-pass" type="password" name="l_pass" placeholder="Password" required /><br>
